...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css" integrity="sha512-Kc323vGBEqzTmouAECnVceyQqyqdsSiqLQISBL29aUW4U/M7pSPA/gEUZQqv1cwx4OnYxTxve5UMg5GT6L4JJg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
  ...
  <body>
    ...
    <section class="bg-gray-50 min-h-screen flex items-center justify-center">
      ...
      >
        <div class="md:block hidden w-1/2">
          <img
            class="rounded-2xl"
            src="https://plus.unsplash.com/premium_photo-1680132275203-8c1e72e4507a?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          />
        </div>
    ...
    <div
      class="w-96 bg-red-500 p-4 text-white fixed top-5 right-5 rounded-xl flex items-center justify-between gap-4"
      id="error"
    >
